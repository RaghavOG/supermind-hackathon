...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-start justify-center bg-black px-4 py-10 sm:p-8 md:p-12 lg:p-24 mt-4"
    style={{
    ...
    >
      <h1 className="text-3xl sm:text-3xl lg:text-4xl xl:text-6xl font-bold text-white mb-8 lg:mb-12 ">
